...
Нужно создать виртуальную среду для Python и написать в терминал __pip install -r requirements.txt__ для установки зависимостей
...
ML-Model Api на Python как api для бэкенда и ml-model для прогнозирования
