...
# ============================================================
# ПАРАМЕТРЫ, КОТОРЫЕ ИСПОЛЬЗУЕТ ML
# ============================================================
...
FEATURES = [
    ...
    # Не дата.
    # Используется только как сезонный параметр.
    "month",
]
...
def load_weather_file(file_path, year):
    ...
    # --------------------------------------------------------
    # ВАЖНО:
    # Исходный CSV содержит сначала блок location,
    # а потом weather-таблицу.
    #
    # Поэтому сначала читаем строки и находим weather header.
    # --------------------------------------------------------
    ...
    # --------------------------------------------------------
    # Берём только weather-часть CSV
    # --------------------------------------------------------
...
def check_columns(df):
    ...
    # Нужна дата для получения месяца.
...
def prepare_dataset():
    ...
    # Для контроля берём исходные данные отдельно.
    print("\nОжидаемый объём:")
